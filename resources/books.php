...
$query = "select title,author,company,published_year,in_rack,category.name as name from books join category on books.category_id = category.category_id where title like ('" . $title . "') and author like('" . $author . "') and category.name like ('" . $category . "') order by popularity";
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            while ($row = mysql_fetch_array($result)) {
                                ...
                                <td>" . $row['name'] . "</td>
                                <td>" . $row['in_rack'] . "</td>
                                <td><button class='btn btn-info' type='button'>Issue
                                </button></td>
                            </tr>";
                            }?>
                        </tbody>
